...
export default async function PortalDecisionsPage({ params }: { params: { token: string } }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h1 style={{ fontSize: '22px', fontWeight: 500, color: 'var(--text-primary)', margin: '0 0 4px' }}>Decisions</h1>
          ...
          return (
            <div
              ...
              style={{
                ...
                border: dec.status === 'pending_approval'
                  ? '0.5px solid #D6B97B'
            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                ...
                <div style={{
                  ...
                  background: 'var(--brand-50)', padding: '3px 8px', borderRadius: '6px',
                  flexShrink: 0, marginTop: '2px', fontFamily: 'monospace',
                }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {dec.description && (
                    <p style={{ fontSize: '12px', color: 'var(--text-secondary)', margin: '5px 0 0', lineHeight: 1.5 }}>
                      {dec.description}
                    </p>
                  )}
                  ...
                  {dec.status === 'pending_approval' && pending.length > 0 && (
                    <div style={{
                      marginTop: '8px', padding: '7px 10px', background: 'var(--warning-bg)',
                      borderRadius: '7px', fontSize: '12px', color: 'var(--warning-text)',
                      display: 'flex', alignItems: 'center', gap: '6px',
                    }}>
                      <span>✉</span>
                      <span>
                        Approval link sent to {maskEmail(pending[0].recipient_email)} · Check your email
                      </span>
                    </div>
                  )}
                </div>
